...
class AdvertForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'featured_image4': forms.FileInput(attrs={'id': 'featured_image1', 'class': 'form-control-file'}),
            'featured_image5': forms.FileInput(attrs={'id': 'featured_image2', 'class': 'form-control-file'}),
            'featured_image6': forms.FileInput(attrs={'id': 'featured_image3', 'class': 'form-control-file'}),
            'featured_image7': forms.FileInput(attrs={'id': 'featured_image2', 'class': 'form-control-file'}),
            'featured_image8': forms.FileInput(attrs={'id': 'featured_image3', 'class': 'form-control-file'}),
